  ...
  return (
    <div className='bg-[#222831] text-white flex flex-col items-center gap-8 w-full'>
      ...
      <div className="flex justify-center">
        ...
        {(showAll || showFullStack) && <div className=' mt-2 lg:mt-4 grid grid-cols-1 md:grid-cols-2 px-0 md:px-6 xl:px-0 w-5/6 md:w-full xl:w-[80%] 2xl:w-[65%] gap-10 md:gap-6 lg:gap-10'>
          <ProjectCard
