        ...
        <div className='flex flex-col xl:flex-row items-center justify-center space-y-6 mt-10'>
          ...
          <div className='flex flex-col items-center gap-4 mt-5 w-full'>
            ...
            <div className='z-0 flex flex-col items-center space-y-6'>
              <img src='https://MichaelAlex03.github.io/PersonalSite/images/profile.jpg' className='rounded-full'/>
          ...
          <div className='flex flex-row justify-evenly items-center w-full md:w-3/5 lg:w-2/3 xl:w-3/4 py-6 px-2'>
            ...
            <div className='flex flex-col justify-center w-full space-y-2 lg:space-y-4'>
              ...
              <div className='flex flex-col justify-center items-center rounded-lg border-sky-400 p-1 space-y-1 transition duration-300 ease-in-out transform hover:scale-110'>
                <img src='https://MichaelAlex03.github.io/PersonalSite/images/skills/javascript.svg' className='h-[30px] md:h-[40px]'/>
              ...
              <div className='flex flex-col justify-center items-center rounded-lg  border-white p-1 space-y-1 transition duration-300 ease-in-out transform hover:scale-110'>
                <img src='https://MichaelAlex03.github.io/PersonalSite/images/skills/html-5.svg' className='h-[30px] md:h-[40px]'/>
                <h1 className='text-sm md:text-lg '>HTML</h1>
              </div>

              <div className='flex flex-col justify-center items-center rounded-lg  border-sky-400 p-1 space-y-1 transition duration-300 ease-in-out transform hover:scale-110'>
                <img src='https://MichaelAlex03.github.io/PersonalSite/images/skills/tailwindcss.svg' className='h-[30px] md:h-[40px]'/>
            ...
            <div className='flex flex-col justify-center w-full space-y-2 lg:space-y-4'>
              ...
              <div className='flex flex-col justify-center items-center rounded-lg  border-white p-1 space-y-1 transition duration-300 ease-in-out transform hover:scale-110'>
                <img src='https://MichaelAlex03.github.io/PersonalSite/images/skills/react.svg' className='h-[30px] md:h-[40px]'/>
                <h1 className='text-sm md:text-lg '>React</h1>
              </div>

              <div className='flex flex-col justify-center items-center rounded-lg  border-sky-400 p-1 space-y-1 transition duration-300 ease-in-out transform hover:scale-110'>
                <img src='https://MichaelAlex03.github.io/PersonalSite/images/skills/postgresql.svg' className='h-[30px] md:h-[40px]'/>
                <h1 className='text-sm md:text-lg '>PostgreSQL</h1>
              </div>

              <div className='flex flex-col justify-center items-center rounded-lg  border-sky-400 p-1 space-y-1 transition duration-300 ease-in-out transform hover:scale-110'>
                <img src='https://MichaelAlex03.github.io/PersonalSite/images/skills/nodejs.svg' className='h-[30px] md:h-[40px]'/>
                <h1 className='text-sm md:text-lg '>NodeJS</h1>
              </div>

              <div className='flex flex-col justify-center items-center rounded-lg  border-white p-1 space-y-1 transition duration-300 ease-in-out transform hover:scale-110'>
                <img src='https://MichaelAlex03.github.io/PersonalSite/images/skills/docker.svg' className='h-[30px] md:h-[40px]'/>
            ...
            <div className='flex flex-col justify-center space-y-2 lg:space-y-4 w-full'>
              ...
              <div className='flex flex-col justify-center items-center rounded-lg  border-sky-400 p-1 space-y-1 transition duration-300 ease-in-out transform hover:scale-110'>
                <img src='https://MichaelAlex03.github.io/PersonalSite/images/skills/mongodb.svg' className='h-[30px] md:h-[40px]'/>
                <h1 className='text-sm md:text-lg '>MongoDB</h1>
              </div>

              <div className='flex flex-col justify-center items-center rounded-lg  border-white p-1 space-y-1 transition duration-300 ease-in-out transform hover:scale-110'>
                <img src='https://MichaelAlex03.github.io/PersonalSite/images/skills/git-icon.svg' className='h-[30px] md:h-[40px]'/>
                <h1 className='text-sm md:text-lg'>Git</h1>
              </div>

              <div className='flex flex-col justify-center items-center rounded-lg  border-white p-1 space-y-1 transition duration-300 ease-in-out transform hover:scale-110'>
                <img src='https://MichaelAlex03.github.io/PersonalSite/images/skills/typescript.svg' className='h-[30px] md:h-[40px]'/>
